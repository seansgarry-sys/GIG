...
class Settings:
    site_title: str = os.getenv("SITE_TITLE", "Scalla Song Requests")
    performer_name: str = os.getenv("PERFORMER_NAME", "Scalla")
    admin_password: str = os.getenv("ADMIN_PASSWORD", "changeme")
    asset_version: str = os.getenv("ASSET_VERSION", "20260416-brandfix")
    venmo_url: str = os.getenv("VENMO_URL", "https://account.venmo.com/u/Sean-Garry-4")
    instagram_url: str = os.getenv("INSTAGRAM_URL", "https://instagram.com/_scalla__")
    ...
    smtp_username: str = os.getenv("SMTP_USERNAME", "seansgarry@gmail.com")
    smtp_password: str = os.getenv("SMTP_PASSWORD", "")
    smtp_from_email: str = os.getenv("SMTP_FROM_EMAIL", "seansgarry@gmail.com")
